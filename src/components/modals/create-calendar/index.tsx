          ...
          <>
            <ModalHeader className="flex flex-col gap-1">
              ...
              <p className="text-sm text-gray-500">
                {calendarData
                  ? "Edit the details below to update the calendar."
            ...
            <ModalBody>
              ...
              <div className="form-group">
                <label className="text-sm font-medium" htmlFor="icalUrl">
                  Ical URL
                </label>
                <Input
                  type="text"
              ...
              <div className="form-group">
                <label className="text-sm font-medium" htmlFor="shortUrl">
                  Short URL
                </label>
                <Input
                  type="text"
